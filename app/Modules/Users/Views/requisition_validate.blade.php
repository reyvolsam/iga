...
@section('js')
  ...
  {!! HTML::script('statics/js/customs/requisicion_validate.js') !!}
@stop
...
@section('content')
  ...
  <div class="box box-default">
      ...
      <div class="box-body">
      <div id = "requisition_msg"></div><!--/users_msg-->
          ...
          <tbody ng-repeat="elem in vm.requisition_list" ng-init="cont = $index;">
            <tr>
              ...
              <td> 
                ...
                <small class="label 3bg-red" ng-if = "elem.autorize_flag == '0'" >No Autorizado</small>
                <small class="label bg-green" ng-if = "elem.autorize_flag == '1'" >Autorizado</small>
              </td>
              <td ng-if = "elem.autorize_flag == '0' || elem.review_flag == '0'">
                <button class = "btn btn-success btn-xs" id = "del_@{{cont}}" ng-click = "vm.ValidateRequisition(elem.id);" data-toggle="tooltip" data-placement="top" title = "Validar Requisición"> <i class = "fa fa-check-circle"></i> </button>
              </td>
            </tr>
          </tbody>
        </table>
